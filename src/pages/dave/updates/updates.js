...
import CaseUpdateList from '../../../components/dave/case_update_list/case_update_list.js';
import UpdateDetailsSidebar from '../../../components/dave/update_details_sidebar/update_details_sidebar.js';
import FloatingActionButton from '../../../components/universal/fab/fab.js';

import './updates.css';

class UpdatesPageDave extends Component {
    constructor() {
        super();
...
export default UpdatesPageDave;